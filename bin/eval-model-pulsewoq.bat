...
rem
rem Usage:
rem   bin\eval-model-pulsewoq.bat <run_dir> [OPTIONS]
rem   bin\eval-model-pulsewoq.bat data\models\resnet1d\20260101_120000
rem   bin\eval-model-pulsewoq.bat data\models\resnet1d\20260101_120000 --dataset-dir data\dataset
rem   bin\eval-model-pulsewoq.bat data\models\resnet1d\20260101_120000 --device cuda
rem
rem Options:
...
cd /d "%~dp0.."
uv run python scripts\eval-model-pulsewoq.py %*
